...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Trevisan", "bob@gmail.com",  new DateTime(1998, 4, 22), 1000.0, d1);
            Seller s2 = new Seller(2, "Alice Green", "agreen@gmail.com",  new DateTime(1999, 7, 15), 1800.0, d2);
            Seller s3 = new Seller(3, "Mary Hoffman", "hoffman@gmail.com",  new DateTime(1985, 02, 01), 3600.0, d3);
            Seller s4 = new Seller(4, "Alice Green", "agreen@gmail.com",  new DateTime(1999, 7, 15), 1800.0, d4);
            Seller s5 = new Seller(5, "Petter Pan", "petterpan@gmail.com",  new DateTime(1989, 5, 05), 4200.0, d2);
            Seller s6 = new Seller(6, "Aron Pulman", "pulman@gmail.com",  new DateTime(2003, 7, 14), 2900.0, d4);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 8, 25), 11000.0, SaleStatus.Billed, s1);
            ...
            //including the objects in the database and saving changes
